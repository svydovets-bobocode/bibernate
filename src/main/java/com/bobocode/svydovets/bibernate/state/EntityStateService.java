...
/** Entity state management service. This service allows to get, set and validate entity state. */
public interface EntityStateService {
    ...
    /**
     * Allows to set entity state by entity key object. Before setting an Entity state validates if
     * the entity key current state can be changed to entity state that passed as second argument
     * {@link EntityState}
     *
    ...
    /**
     * Allows to set Entity state by entity object. Before setting an entity state validates if the
     * entity key current state can be changed to entity state that passed as second argument {@link
     * EntityState}
     *
    ...
    /**
     * Validate if an Entity state by entity key is in currentState and can be changed to passed
     * state.
     *
