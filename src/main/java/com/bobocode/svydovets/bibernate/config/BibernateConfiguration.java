...
@Slf4j
//todo: add JavaDoc and README guide. This is the starting point for our consumers to use the framework
public class BibernateConfiguration {
    private ConfigurationSource source;
    private final DataSource dataSource;
    private final SqlQueryBuilder sqlQueryBuilder;

    //todo: should it be public? Consumer should use only "configure" and "buildSessionFactory" methods
    ...
    public SessionFactory buildSessionFactory() {
        ...
        log.info(
                ...
                dataSource,
                sqlQueryBuilder);
        //todo: Should we return new every time? Maybe it should be the single object of the SessionFactory per app
